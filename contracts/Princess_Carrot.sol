...
contract Princess_Carrot is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Princess Carrot: not owner");
        _;
    }
     ...
     */
    constructor() ERC721A("Princess Carrot", "Princess") {
        owner = msg.sender;
    }
    ...
    function mint(uint256 quantity) public payable {
        require(
            ...
            "Princess Carro: exceed max supply"
        );
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "Princess Carro: not exist");
